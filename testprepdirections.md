...
---
Q2. Functions & Lists of Objects You are given a list of ThemeParkPass objects created from the class above.
Write a function called
count_premium_passes that:
